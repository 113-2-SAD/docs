...
- [雲原生應用架構指南](https://www.cncf.io/blog/2017/05/15/developing-cloud-native-applications/)
- [CNCF 雲原生定義](https://github.com/cncf/toc/blob/main/DEFINITION.md)
- [12 因素應用方法論](https://12factor.net/)
- [容器化微服務架構模式](https://microservices.io/patterns/microservices.html)
- [Docker 在生產環境中的最佳實踐](https://docs.docker.com/develop/dev-best-practices/)
- [Kubernetes 文檔](https://kubernetes.io/docs/home/)
- [雲原生安全性考量](https://www.aquasec.com/cloud-native-academy/cloud-native-applications/cloud-native-security/)
- [服務網格介紹](https://istio.io/latest/docs/concepts/what-is-istio/)
- [DevOps 與 SRE 實踐](https://sre.google/workbook/table-of-contents/)
- [可觀測性平台與工具比較](https://opentracing.io/docs/overview/what-is-tracing/) 